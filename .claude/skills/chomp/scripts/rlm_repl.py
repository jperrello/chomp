...
Injected variables: context, content, buffers
Injected helpers: peek, grep, chunk_indices, write_chunks, add_buffer
"""
...
DEFAULT_STATE_PATH = Path("chomp/.rlm_state/state.pkl")
